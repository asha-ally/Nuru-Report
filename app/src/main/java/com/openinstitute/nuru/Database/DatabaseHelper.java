...
import static com.openinstitute.nuru.AppFunctions.func_formatDateFromString;
...
public class DatabaseHelper extends  SQLiteOpenHelper {
    ...
    private static final String KEY_USER_CONF_PASS= "user_conf_pass";
    ...
    private static final String CREATE_ACCOUNTS_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_ACCOUNTS + " ( " +
            ...
            "  `" + KEY_USER_NAME + "` TEXT," +
            "  `" + KEY_USER_PROFILE + "` TEXT," +
            "  `" + KEY_USER_PHONE + "` TEXT," +
            "  `" + KEY_USER_EMAIL + "` TEXT," +
            "  `" + KEY_USER_PASS + "` TEXT," +
            "  `" + KEY_USER_CONF_PASS + "` TEXT," +
            "  `" + KEY_USER_DATE + "` TEXT" +
            ")";
    ...
    private static final String KEY_RES_FILE= "post_filepath";
    ...
    private static final String CREATE_RESOURCES_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_RESOURCES+ " ( " +
            ...
            " `" + KEY_RES_FILE + "` TEXT " +
            ")";
            /*" `" + KEY_POST_ID + "` TEXT DEFAULT 0 NOT NULL," +*/
    ...
    public void customDbAction(){
        ...
        //String dropTablePosts = "DROP TABLE IF EXISTS " + TABLE_RESOURCES+ "; ";
        ...
        //String alterTableResources = "ALTER TABLE " + TABLE_RESOURCES + " ADD " + KEY_POST_ID + " TEXT DEFAULT 0 NOT NULL ;";

        //db.execSQL(alterTableResources); //IF EXISTS
        //db.execSQL(CREATE_RESOURCES_TABLE);

        /*CREATE_RESOURCES_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_RESOURCES+ " ( " +
            " `" + KEY_RES_ID + "` INTEGER primary key autoincrement," +
            " `" + KEY_POST_ID + "` TEXT DEFAULT 0 NOT NULL," +
            " `" + KEY_RES_IMAGE+ "` TEXT," +
            " `" + KEY_RES_AUDIO + "` TEXT, " +
    ...
    public void addAccountNew(JSONObject user_Data) {
        ...
        //if (field_Data != null || user_status.equals("active")) {
            ...
            try {
                ...
                values.put(KEY_USER_NAME, user_Data.getString("name") );
                values.put(KEY_USER_PROFILE, user_Data.getString("profile") );
                ...
                values.put(KEY_USER_CONF_PASS, user_Data.getString("profile_confirmation") );
    ...
    public void addAccount(User account) {
        ...
        values.put(KEY_USER_NAME, account.getUser_name());
        values.put(KEY_USER_PROFILE, account.getUser_profile());
        ...
        values.put(KEY_USER_CONF_PASS, account.getUser_password());
    ...
    public JSONObject getAccount( String user_email) {
...
//        + md5_pass +"%'
        ...
        String selectQuery  = "SELECT  * FROM " + TABLE_ACCOUNTS + " WHERE " + KEY_USER_EMAIL +" = '"+ user_email +"'";
        ...
        if (cursor.getCount() != 0) {
            ...
            try {
                ...
                currentRec.put(KEY_USER_NAME, cursor.getString(cursor.getColumnIndex(KEY_USER_NAME)));
                currentRec.put(KEY_USER_PROFILE, cursor.getString(cursor.getColumnIndex(KEY_USER_PROFILE)));
    ...
    public List<User> getAllAccounts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                account.setUser_name(cursor.getString(1));
                account.setUser_profile(cursor.getString(2));
                ...
                account.setUser_conf_pass(cursor.getString(6));
...
//        values.put(KEY_USER_LNAME, account.getUser_lname());
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    /*try {
                        ...
                        Log.d("fileGetRecord ", "Key: "+ key + " Value: " + value);
    ...
    public String post_Edit(JSONObject post, String post_id) {
        ...
        try {
            ...
            //audio_url = post.getString("audio_url");

            Log.d("post_Edit", image_url);

            if (image_url.trim().length() > 4 ) {
                JSONObject resData = new JSONObject();
                try {
                    resData.put("post_id", insert);
                    resData.put("image_url", image_url.trim());
           ...
           /* if (image_url.length() > 4 && image_url.trim().substring(0,1).equals("[")) {
                String pichas_clean = image_url.trim().substring(1, image_url.trim().length() - 1);
                ...
                for (String file_item : filesList) {
                    ...
                    if(file_item.length() > 4) {
                        ...
                        try {
                            resData.put("post_id", insert);
                            resData.put("image_url", file_item.trim());
                            resData.put("description", "");
                            addResource(resData);
    ...
    public void addResource(JSONObject post) {
        ...
        try {
            ...
            contentValues.put(KEY_RES_FILE, ""); /*post.getString("image_url")*/

            sqLiteDatabase.replace(TABLE_RESOURCES, null, contentValues);

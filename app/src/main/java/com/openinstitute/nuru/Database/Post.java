...
public class Post {
    ...
    public String post_files;




    public Post(int post_Id, String post_title, String post_details, String record_date, String userId, String post_imageUrl, String post_audioUrl, String post_category, String post_tag, String post_project, String post_latitude, String post_longitude, String post_session, String post_files) {
    ...
    public String getPost_files() { return post_files; }

    public void setPost_files(String post_files) { this.post_files = post_files; }
    ...
    public JSONObject getPostAll(){
        ...
        try {
		    ...
		    postData.put("post_files",this.post_files);

...
//import com.openinstitute.nreport.PostActivity;
//import com.openinstitute.nreport.ProfileActivity;
import com.google.gson.JsonParser;
import com.openinstitute.nuru.SignUpActivity;
...
//    private PostActivity caller_transfer;
    private SignUpActivity caller_user_signup;
//    private ProfileActivity caller_user_profile;

    OnAppAsyncPostComplete caller;
    //private Activity form_sender;
    private final Context form_sender;
    String method = "POST";
...
//        }
        ...
        if(category_id.equals("user_signup")){
            caller_user_signup = (SignUpActivity) a;
        }

//        if(category_id.equals("user_profile")){
//            caller_user_profile = (ProfileActivity) a;
//        }
    ...
    protected String doInBackground(String... params) {
        ...
        BasicNameValuePair report_data_BNVP = new BasicNameValuePair("param_report_data", report_data.toString());
...
//
//        if(category_id.equals("user_profile")){
//            caller_user_profile.userAsyncResponse(result);
//        }

        if(category_id.equals("user_signup")){
            caller_user_signup.userAsyncResponse(result);
        }
